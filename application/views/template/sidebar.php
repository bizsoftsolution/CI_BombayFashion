            ...
            <ul class="navigation navigation-main navigation-accordion">
               ...
               <li class="active"><a href="<?php echo base_url('Dashboard');?>"><i class="icon-home7"></i> <span>Dashboard</span></a></li>
				...
				echo( "					<ul class=\"hidden-ul\">");
						...
						<li <?php echo ($this->uri->segment(1) == 'ShippingCharge' ? 'class="active"' : ''); ?>><a href="<?php echo base_url('ShippingCharge');?>" class="legitRipple"><i class="icon-film4"></i>Shipping Charge</a></li>
					</ul>
				</li>
			   ...
			   <li ><a href="<?php echo base_url('Order');?>"><i class="icon-price-tags2"></i> <span>Order List</span></a></li>
			   <li ><a href="<?php echo base_url('Order/deliveredList');?>"><i class="icon-newspaper"></i> <span>Delivered List</span></a></li>
