                                ...
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12 single-product-details">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-reveiw">
                                            <p style="text-align:justify;margin: 13px 0 50px;    word-spacing: -2px;
    color: #777;
    font-size: 13.5px;">
												<?php 
												echo $small = substr($row->product_description, 0, 500);
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="product-description-tab custom-tab">
								...
								<div class="tab-content" style="padding:5px 20px;">
									<div class="tab-pane active" id="product-des" style="overflow-y: scroll;
    height: 300px;">
										<p style="text-align:justify;"><?php echo $row->product_description; ?></p>
									</div>
									<div class="tab-pane" id="product-rev" style="overflow-y: scroll;
    height: 720px;">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<?php 
											$id = $this->uri->segment(3);
												...
												{
											?>	
										<div class="panel panel-flat timeline-content" style="margin-right: 15px;
    margin-left: 15px;">
												...
												<div class="panel-body">
													<div class="col-md-8">
														...
														<h6 class="content-group">
															...
															<a href="#"><?php echo $data7_row->name; ?></a>
														</h6>

														<blockquote style="    border-left: 4px solid #ffbb00;">
															<p style="font-size: 14px;"><?php echo $data7_row->description; ?></p>
															<footer><cite title="Source Title"><?php echo date("M d, Y", strtotime($data7_row->date)); ?></cite></footer>
														</blockquote>
													</div>
													<div class="col-md-4" style="color: #0381bb;margin:40px 0 0 0;font-size:14px;">
																<div class="col-md-4"><b style="font-size: 12px;text-align:right;">Quality</b></div>
										...
										<div class="col-md-4"><b style="font-size: 12px;">Price</b></div>
										...
										<div class="col-md-4"><b style="font-size: 12px;">Value</b></div>
			...
			<div class="col-md-12">
												<br>
				<div class="product-rev-right" style="background: white;">
