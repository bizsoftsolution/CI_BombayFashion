                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="home">
											<div class="table-responsive">
												<table class="table">
													...
													<?php 
														$i=1;
														//$data123 = $this->db->get_where('');
														$this->db->select('*');
														$this->db->from('tbl_order');
														//$this->db->join('tbl_order_details', 'tbl_order.id = tbl_order_details.order_id');
														$this->db->where('customer_id', $this->session->userdata('user_id'));
														$query = $this->db->get();
														$result = $query->result();
														foreach($result as $row_val)
														{
														
													?>
													<tr>
														<td><?php echo $i; ?></td>
														<td><?php echo date("d M Y",strtotime($row_val->order_date)); ?></td>
														<td><?php echo $row_val->grandtotal; ?></td>
														<td>
														<?php 
															if($row_val->status == "PROCESSING")
															{
														?>
														...
														border-radius: 2px;">Pending</span>
														<?php 
															}
															else
															{		
