							...
							<table>
								...
								<tbody>
									...
									<tr class="cart_item">
										...
										<td class="product-total" style="text-align:right;">
											...
											<span class="amount"><?php echo number_format($item['subtotal'], 2) ?></span>
										</td>
									</tr>
									<?php 
									}
								...
								<tfoot>
									<tr class="cart-subtotal">
										<th style="text-align:left;">Cart Subtotal ( RM )</th>
										<td style="text-align:right;"><span class="amount" ><?php echo number_format($grand_total,2); ?></span></td>
									</tr>
									<tr>
										...
										<select name="Customer_ID" id="Customer_ID" class="form-control" required>
											...
											<?php 
												$data124 = $this->db->get('tbl_shipping_charge')->result();
												foreach($data124 as $res2)
												{
											?>
											<option title="<?php echo $res2->shipping_charge; ?>" value="<?php echo $res2->shipping_charge; ?>"><?php echo $res2->city_name; ?></option>
											<?php 
												}
											?>
													...
													<tr class="shipping">
                                                        <th style="text-align:left;">Shipping Charge (RM)</th>
														<td>
														<input type="hidden" value="<?php echo $grand_total; ?>" id="subtotal">
														<input type='text' name="Order_chrge" id="Order_chrge" readonly="readonly" class="form-control" style="text-align:right;border: none;" /></td>
													</tr>
									...
									foreach ($cart as $item)
									{
									$gst_query = $this->db->get_where('tbl_product', array("id"=>$item['id']))->result();
										
										foreach($gst_query as $gst_query_val)
										{
											
											//if($gst_query_val->gst != 0)
											//{
												if($i==1)
												{
										?>
										<tr>
											...
											<td>
												<input type="text" readonly name="gst_value" id="gst_value" class="form-control" value="6.00" style="text-align:right;border: none;" >	
											</td>
										</tr>
										<?php
												}
									...
									<script>
										$(document).ready(function(){
											...
											var shipping = parseFloat($('#subtotal').val());
											var end_rng = parseFloat($('#Customer_ID').val());
											var gst_rng = parseFloat($('#gst_value').val());
			
											//var shipping = $('#subtotal').val();
											//alert(shipping);
											var gst_cal = shipping * gst_rng / 100;
											//alert(gst_cal);
											var totl = shipping + end_rng + gst_cal;
											//alert(totl);
											$('#Order_chrge').val(email);
											$('#Order_total').val(totl);
										});
										});
									</script>
									<tr class="order-total">
										<th style="text-align:left;">Order Total ( RM )</th>
										<td><strong><span class="amount">
										<input type="text" readonly id="Order_total" value=".00" style="text-align:right;border: none;" >
										 </span></strong>
										</td>
									</tr>								
								</tfoot>
