   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			<div class="col-md-6">
				<h3 class="panel-title">Add New Size
			</h3>
			</div>
			<div class="col-md-6">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-8">
               ...
               <?php } ?>
               <form name="add"   method="POST" action="<?php echo  base_url();?>Size/Add" class="form-horizontal form-validate-jquery">
                  <div class="form-body">
                     <div class="form-group">
                        <label class="control-label col-md-3"><b>Size Name</b> <strong style="color:red;">*</strong></label>
                        <div class="col-md-9">
                           <input name="sizename" placeholder="Size Name" class="form-control" type="text" required="required">
