...
<!--start-shop-product-area-->
				...
				<div class="col-md-9">
					<div class="jplist-panel box panel-top" style="background: rgba(227, 227, 227, 0.65);padding: 3px 12px;">
						<?php 
							...
							$data3_1 = $this->db->get_where("tbl_sub_category", array("id"=>$cid))->result();
    ...
    font-size: 21px;
    padding: 13px;
    color: #222;"><?php echo $data2_row->sub_category; ?></div>
						<?php 
							}
						?>
						<!-- items per page dropdown -->
					...
					<div class="list box text-shadow">
						<!-- Start-single-product -->
							...
							<?php 
							$cid = $this->uri->segment(3);
							$data3 = $this->db->get_where("tbl_product", array("sub_category_id"=>$cid))->result();
